                    ...
                    <div>
                        <div className="d-flex">
                            <StarRatings
                                ...
                                name='rating'
                                />
                            <span className="no-of-reviews">({room?.numOfReview ? room.numOfReview : 0 } Reviews)</span>
                        </div>
                        <Link className="btn view-btn mt-3 w-100" href={`${process.env.API_URL}rooms/${room?._id}`}
                            >View Details</Link>
                    </div>
                </div>
            </div>
