        ...
        <div className="row wrapper mt-5">
            <div className="col-10 col-lg-5">
                ...
                <div className="form-group mt-3">
                    ...
                    <select className="form-select" id="guest_field" value={guests} onChange={(e)=>setGuests(e.target.value)}>
                    { [1,2,3,4,5,6].map((num)=>(
                ...
                <button type="submit" className="btn btn-danger form-btn w-100 py-2">Search</button>
                </form>
            </div>
        </div>
    )
