        ...
        <div className="row wrapper">
            <div className="col-10 col-lg-8">
                ...
                <div className="mb-3">
                    ...
                    <select className="form-select" id="room_type_field" name="category" value={category}
                    onChange={onChange}>
                ...
                <div className="row">
                    ...
                    <select className="form-select" id="guest_field" name="guestCapacity" value={guestCapacity}
                    onChange={onChange}>
                        { [1,2,3,4,5,6].map((num)=>(
                    ...
                    <select className="form-select" id="numofbeds_field" name="numOfBeds" value={numOfBeds}
                    onChange={onChange}>
                        { [1,2,3].map((num)=>(
                        <option key={num} value={num}>
                            {num}
                ...
                <button type="submit" className="btn form-btn w-100 py-2 btn-danger" disabled={isLoading}>
